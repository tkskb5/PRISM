...
商材情報を入力するだけで、以下の4フェーズの分析をGemini AIが自動実行します。`,
    ...
    phases: [
        {
            ...
            desc: 'Google検索でSNS・レビューサイト・ブログ等から実在の生活者の声を調査し、ポジティブ・ハック（意外な使い方）、ネガティブ・ペイン（不満）、市場の再定義を抽出します。※ AIの創作ではなく、Google検索で取得したリアルなデータを基に分析します。',
        },
        {
            icon: '💬',
    ...
    features: [
        {
            ...
            steps: [
                ...
                '研究モード（⚡ Test または 🔬 Deep Research）を選択',
        ...
        },
        {
            ...
            title: '研究モードの選択',
            steps: [
                '⚡ Test（テスト） — AIの知識ベースのみで分析。高速（約1〜5分）・低コスト（約3〜20円）ですが、AIが知識を基に声を生成するため、実在しない声が含まれる可能性があります',
                '🔬 Deep Research（本番推奨） — Gemini Deep Research Agentが自律的にWeb上のリアルな声を調査・分析。時間（約5〜15分）とコスト（約20〜50円）はかかりますが、実在するソースに基づいた高品質な分析結果が得られます',
            ],
        },
        {
            icon: '🤖',
            title: 'AIモデルの選択',
            steps: [
                'Gemini 3 Flash（おすすめ）: 高速・低コスト — 通常の分析に最適',
                'Gemini 3 Pro: 高精度 — 深い洞察が必要な案件向け（Testモードで約5分、Deep Researchで約10〜15分）',
            ],
        },
        {
            icon: '📋',
    ...
    tips: [
        '本番の分析には 🔬 Deep Research モードを推奨します。⚡ Test モードはプロンプト調整の確認用です',
